...
const explicitFileIconMeta = {
  ...
  xla: { icon: 'XLA', family: 'sheet' },
  xlam: { icon: 'XLAM', family: 'sheet' },
  dbf: { icon: 'DBF', family: 'sheet' },
  numbers: { icon: 'NO', family: 'sheet' },
  pages: { icon: 'PA', family: 'word' },
  wpd: { icon: 'WPD', family: 'word' },
  wp: { icon: 'WP', family: 'word' },
  wp5: { icon: 'WP5', family: 'word' },
  wp6: { icon: 'WP6', family: 'word' },
  hwp: { icon: 'HWP', family: 'word' },
  hwpx: { icon: 'HWPX', family: 'word' },
  ppt: { icon: 'P', family: 'slide' },
  pot: { icon: 'POT', family: 'slide' },
  key: { icon: 'KEY', family: 'slide' },
  ...
  psb: { icon: 'PSB', family: 'data' },
  pdd: { icon: 'PDD', family: 'data' },
  psdt: { icon: 'PSDT', family: 'data' },
  ai: { icon: 'AI', family: 'data' },
  fla: { icon: 'FLA', family: 'data' },
  xfl: { icon: 'XFL', family: 'data' },
  ait: { icon: 'AIT', family: 'data' },
  eps: { icon: 'EPS', family: 'data' },
  ps: { icon: 'PS', family: 'data' },
  idml: { icon: 'IDML', family: 'layout' },
  icml: { icon: 'ICML', family: 'layout' },
  idms: { icon: 'IDMS', family: 'layout' },
  inx: { icon: 'INX', family: 'layout' },
  xd: { icon: 'XD', family: 'layout' },
  indd: { icon: 'INDD', family: 'layout' },
  indt: { icon: 'INDT', family: 'layout' },
  ase: { icon: 'ASE', family: 'data' },
  aco: { icon: 'ACO', family: 'data' },
  abr: { icon: 'ABR', family: 'data' },
  csh: { icon: 'CSH', family: 'data' },
  pat: { icon: 'PAT', family: 'data' },
  grd: { icon: 'GRD', family: 'data' },
