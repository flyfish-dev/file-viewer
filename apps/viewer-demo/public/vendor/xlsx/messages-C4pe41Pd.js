(/* @__PURE__ */ "[data-viewer-anchor-id],.pdfViewer .page,.docx-wrapper section,.docx p,.docx li,.docx table,.markdown-body h1,.markdown-body h2,.markdown-body h3,.markdown-body h4,.markdown-body h5,.markdown-body h6,.markdown-body p,.markdown-body li,.markdown-body pre,.markdown-body table,article h1,article h2,article h3,article h4,article h5,article h6,article p,article li,article pre,article table,pre code,p,li,tr,h1,h2,h3,h4,h5,h6,pre,table".split(",")).join(","), [
	".viewer-actions",
	".viewer-watermark",
	".state-panel",
	".pdf-toolbar",
...
//#endregion
//#region ../../packages/core/dist/features/document/dom/providers.js
var e = /* @__PURE__ */ new WeakMap(), t = /* @__PURE__ */ new WeakMap(), n = (e) => !!e && e.nodeType === 1, r = (e, t) => {
	if (!(e != null && e.querySelectorAll)) return [];
	let i = Array.from(e.querySelectorAll(t));
	n(e) && e.shadowRoot && i.push(...r(e.shadowRoot, t));
	let a = Array.from(e.querySelectorAll("*"));
	for (let e of a) e.shadowRoot && i.push(...r(e.shadowRoot, t));
	return i;
}, i = (t, n) => {
	e.set(t, n), t.dataset.viewerZoomProvider = t.dataset.viewerZoomProvider || "custom", t.__flyfishViewerZoomProvider = n;
}, a = (t) => {
	t && (e.delete(t), delete t.dataset.viewerZoomProvider, delete t.__flyfishViewerZoomProvider);
}, o = (t) => {
	if (!t) return null;
	let i = n(t) ? e.get(t) || t.__flyfishViewerZoomProvider : null;
	if (i) return i;
	let a = r(t, "[data-viewer-zoom-provider]")[0];
	return a && (e.get(a) || a.__flyfishViewerZoomProvider) || null;
}, s = (e, n) => {
	t.set(e, n), e.dataset.viewerViewStateProvider = e.dataset.viewerViewStateProvider || "custom", e.__flyfishViewerViewStateProvider = n;
}, c = (e) => {
	e && (t.delete(e), delete e.dataset.viewerViewStateProvider, delete e.__flyfishViewerViewStateProvider);
}, l = (e) => {
	if (!e) return null;
	let i = n(e) ? t.get(e) || e.__flyfishViewerViewStateProvider : null;
	if (i && (!n(e) || e.dataset.viewerViewStateProvider !== "generic")) return i;
	let a = r(e, "[data-viewer-view-state-provider]"), o = a.find((e) => e.dataset.viewerViewStateProvider !== "generic"), s = a.find((e) => e.dataset.viewerViewStateProvider === "generic"), c = o || s;
	return c ? t.get(c) || c.__flyfishViewerViewStateProvider || null : i || null;
}, u = [
	"auto",
	"scroll",
	"overlay"
], d = (e) => Math.max(0, e.scrollHeight - e.clientHeight), f = (e, t = {}) => {
	var n, r;
	...
	return (t.overflowValues || u).includes(c);
}, p = (e, t = {}) => {
	if (!e) return null;
	...
	return i && f(i, t) ? i : f(e, t) ? e : Array.from(e.querySelectorAll(r)).filter((e) => f(e, t)).sort((e, t) => d(t) - d(e))[0] || i || e;
}, m = () => {
...
}, g = ({ mode: e, viewportWidth: t, viewportHeight: n, contentWidth: r, contentHeight: i, minScale: a, maxScale: o }) => {
	...
	if (!(!Number.isFinite(d) || d <= 0)) return h(d, a, o);
}, _ = {
...
}, y = "zh-CN", b = "en-US", x = Object.freeze({
	"zh-CN": {
	...
	if (t) {
		...
		if (t === "de" || t.startsWith("de-")) return "de-DE";
	...
	if (e && e !== "auto") return S(e) || "en-US";
	let t = C();
	for (let e of t) {
		let t = S(e);
		if (t) return t;
	}
	return t.length > 0 ? b : y;
}, T = (e) => {
	var t;
	return ((t = e == null ? void 0 : e.i18n) == null ? void 0 : t.messages) || (e == null ? void 0 : e.messages);
}, E = (e) => {
	var t;
	return w(((t = e == null ? void 0 : e.i18n) == null ? void 0 : t.locale) || (e == null ? void 0 : e.locale));
}, D = (e, t = {}) => e.replace(/\{([a-zA-Z0-9_.-]+)\}/g, (e, n) => {
	let r = t[n];
	return r == null ? "" : String(r);
}), O = (e, t, n = {}) => {
	let r = E(e), i = T(e);
	return D((typeof i == "function" ? i(t, n, r) : i == null ? void 0 : i[t]) || x[r][t] || x["en-US"][t] || x["zh-CN"][t], n);
}, k = (e) => (t, n) => O(e, t, n);
//#endregion
export { m as a, o as c, c as d, a as f, g as i, s as l, E as n, p as o, O as r, l as s, k as t, i as u };
