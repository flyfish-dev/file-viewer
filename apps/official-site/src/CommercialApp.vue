    ...
    ? [
        {
          dimension: '产品定位',
          icon: Boxes,
          open: '浏览器原生、多格式、离线优先的开源预览组件。覆盖 244 个已注册扩展名与 34 条独立预览链路，其中 221 个稳定、23 个实验。',
          commercial:
    ...
    : [
        {
          ...
          icon: Boxes,
          open: 'A browser-native, multi-format, offline-first open-source viewer covering 244 registered extensions across 34 preview pipelines: 221 stable and 23 experimental.',
          commercial:
