    ...
    ? [
        {
          dimension: '产品定位',
          icon: Boxes,
          open: '浏览器原生、多格式、离线优先的开源预览组件。覆盖 273 个已注册扩展名与 46 条独立预览链路，其中 224 个稳定、49 个实验。',
          commercial:
    ...
    : [
        {
          ...
          icon: Boxes,
          open: 'A browser-native, multi-format, offline-first open-source viewer covering 273 registered extensions across 46 preview pipelines: 224 stable and 49 experimental.',
          commercial:
