    ...
    <DocsPage toc={[]}>
      <article className="fv-home">
        ...
        <dl className="fv-home-facts">
          <div><dt>273</dt><dd>{chinese ? '个已注册扩展名（224 稳定 / 49 实验）' : 'registered extensions (224 stable / 49 experimental)'}</dd></div>
          <div><dt>46</dt><dd>{chinese ? '条预览链路' : 'preview pipelines'}</dd></div>
