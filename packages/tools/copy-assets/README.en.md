...
```bash
npm install -D file-viewer-copy-assets@2.2.8
npx --yes file-viewer-copy-assets@2.2.8 ./public/file-viewer
```
...
pnpm dlx file-viewer-copy-assets@2.2.8 ./public/file-viewer
```
