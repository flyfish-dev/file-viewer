...
```bash
npm install -D file-viewer-copy-assets@2.3.2
npx --yes file-viewer-copy-assets@2.3.2 ./public/file-viewer
```
...
pnpm dlx file-viewer-copy-assets@2.3.2 ./public/file-viewer
```
