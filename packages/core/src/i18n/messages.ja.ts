...
export const JA_JP_MESSAGES: Record<FileViewerMessageKey, string> = {
  ...
  'text.code.formattedPreview': '整形済みプレビュー',
  'text.code.showOriginal': '元のソースを表示',
  'text.html.preview': 'ページプレビュー',
  'text.html.source': 'HTML ソース',
  'text.html.safePreview': '静的プレビュー。スクリプトと外部リソースは無効です。',
  'text.code.showFormatted': '整形済みプレビューを表示',
