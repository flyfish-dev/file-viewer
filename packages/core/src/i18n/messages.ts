...
const ZH_CN_MESSAGES: Record<FileViewerMessageKey, string> = {
  ...
  'text.code.formattedPreview': '格式化预览',
  'text.code.showOriginal': '查看原始源码',
  'text.html.preview': '页面预览',
  'text.html.source': 'HTML 源码',
  'text.html.safePreview': '静态预览，不执行脚本或加载外部资源',
  'text.code.showFormatted': '查看格式化预览',
...
const EN_US_MESSAGES: Record<FileViewerMessageKey, string> = {
  ...
  'text.code.formattedPreview': 'Formatted preview',
  'text.code.showOriginal': 'Show original source',
  'text.html.preview': 'Page preview',
  'text.html.source': 'HTML source',
  'text.html.safePreview': 'Static preview. Scripts and external resources are blocked.',
  'text.code.showFormatted': 'Show formatted preview',
