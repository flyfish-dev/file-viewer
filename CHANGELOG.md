...
87 个主线包使用 `3.0.3`，`msdoc-viewer` 使用 `0.2.6`。上游依赖为 DOCX `0.3.30`、styled-exceljs `0.21.5`、CAD `0.8.2` 和 DWF `0.6.7`。Vue 2.6/2.7 支持与既有 Full 能力保持不变，pako 3 继续暂缓。此 patch 版本也包含 HTML 源码切换、AMD 接入和 CAD 图片下载等新增能力。
