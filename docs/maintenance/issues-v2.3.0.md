...
eight reproducible issues were closed and #200 remains open because its source PPTX is still
missing. Gitee returned no open issues. GitHub Dependabot and secret-scanning both returned zero
