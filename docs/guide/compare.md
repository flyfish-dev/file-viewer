...
| --- | --- | --- |
| Formats | 265 registered extensions (223 stable, 42 experimental) across 44 preview pipelines for PDF/OFD, Office/iWork, CAD, Typst, archives, email, ebooks, diagrams, media, 3D, data assets, Adobe design files, optional local DICOM, and digital-signature containers; common capabilities use presets while Adobe design, DICOM, and signature formats stay explicit opt-ins | Strengthens the Word, Excel, and PowerPoint deep end. It can replace the Word / Spreadsheet / Presentation capability in `preset-office` while PDF, OFD, CAD, Archive, and other formats continue to use open-source renderers |
